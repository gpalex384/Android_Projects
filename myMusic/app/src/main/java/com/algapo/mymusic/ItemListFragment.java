...
import com.algapo.mymusic.databinding.FragmentItemListBinding;
import com.algapo.mymusic.databinding.ItemListContentBinding;
...
public class ItemListFragment extends Fragment {
    ...
    public static List<MusicItem> ITEMS = new ArrayList<MusicItem>();
    public static Map<String, MusicItem> ITEM_MAP = new HashMap<String, MusicItem>();
    ...
    private void getDatosVolley(View.OnClickListener onClickListener,
                                View.OnContextClickListener onContextClickListener) {
        String url = "https://mybooks-6a979.web.app/json/mymusic_id.json";
        ...
        JsonObjectRequest request = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
            ...
            public void onResponse(JSONObject response) {
                try {
                    JSONArray mJSONArray = response.getJSONArray("mymusic");//Nombre del json
                    ITEMS.clear();
                    MusicItem item;
                    for (int i = 0; i < mJSONArray.length(); i++) {
                        JSONObject mJSONObject = mJSONArray.getJSONObject(i);
                        item = gson.fromJson(mJSONObject.toString(), MusicItem.class);
    ...
    public static class SimpleItemRecyclerViewAdapter
        ...
        SimpleItemRecyclerViewAdapter(List<MusicItem> items,
                                      View.OnClickListener onClickListener,
                                      View.OnContextClickListener onContextClickListener) {
            mValues = items;
        ...
        public void onBindViewHolder(final ViewHolder holder, int position) {
            holder.mAuthorView.setText(mValues.get(position).banda);
            holder.mTitleView.setText(mValues.get(position).lp);

            Picasso.get().load(mValues.get(position).url_imagen_lp).into(holder.mImageView);
        ...
        class ViewHolder extends RecyclerView.ViewHolder {
            ...
            ViewHolder(ItemListContentBinding binding) {
                ...
                mAuthorView = binding.banda;
                mTitleView = binding.lp;
